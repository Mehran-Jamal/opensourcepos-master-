...
$status="Active"; 
 $insert=mysqli_query($conn,"INSERT INTO tblcustomer (fullname,gender,address,number,maxbalance,remainingbalance,status,date) VALUES ('".$name."','".$gender."','".$address."','".$contact_number."','".$initial_balance."','".$initial_balance."','".$status."','".$date."')");
 if($insert){ 
     $response['status'] = 1; 
...
$sql="UPDATE tblcustomer SET fullname='".$name."',address='".$address."',gender='".$gender."',number='".$contact_number."',date='".$date."' WHERE customerId='".$id."'";
...
if(isset($_POST['delete'])){
    include_once('../database.php');
    $deleteid=$_POST['id'];
    $sql="DELETE FROM tblcustomer WHERE customerId='".$deleteid."'";
