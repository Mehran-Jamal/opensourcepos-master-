...
function totalcash()
{
	var totalcash=$('#close_totalcash').text();
	var cash_draw=$('#total_cash_drawer').val();
	var total =cash_draw-totalcash;
	if(total<0)
	{ 
		$('#total_cash_drawer').css('color','orange');
	}else
	{ 
			$('#total_cash_drawer').css('color','black');
	}
}
...
$('#btn-close').on('click',function(){
	var totalcash=$('#close_totalcash').text();
	var cash_drawer=$('#total_cash_drawer').val();
});
});
</script>
  ...
  <div class="modal-dialog" role="document" style="margin-left:30%;">
    <div class="modal-content" style="width:550px;">
	  ...
	  <div class="row">
		<div class="col-md-12">
			<table >
				...
				<td width="50">=</td>
				<td width="100" id="close_totalcash">0.00</td>
				</tr> 
				</tbody>
			</table>				
		</div> 
			...
			<table  class="close-table" id="close-table">
				...
				<tbody>
				 ...
				 <td>500.00</td>
				 <td>x</td>
				 <td><input id="five_hundred" class="form-control" type="number" value="0"></td>
				<td style="display:none;">0</td>
				 </tr>
				  <tr>
				 <td>200.00</td>
				 <td>x</td>
				 <td><input id="two_hundred"class="form-control" type="number" value="0"></td>
				 <td style="display:none;">0</td>
				 </tr>
				  <tr>
				 <td>100.00</td>
				 <td>x</td>
				 <td><input id="one_hundred" class="form-control" type="number" value="0"></td>
				 <td style="display:none;">0</td>
				 </tr>
				  <tr>
				 <td>50.00</td>
				 <td>x</td>
				 <td><input id="fifty" class="form-control" type="number" value="0"></td>
				 <td style="display:none;">0</td>
				 </tr>
				  <tr>
				 <td>20.00</td>
				 <td>x</td>
				 <td><input id="twenty" class="form-control" type="number" value="0"></td>
				 <td style="display:none;">0</td>
				 </tr>
				  <tr>
				 <td>10.00</td>
				 <td>x</td>
				 <td><input id="ten" class="form-control" type="number" value="0"></td>
				<td style="display:none;">0</td>
				 </tr>
				  <tr>
				 <td>5.00</td>
				 <td>x</td>
				 <td><input id="five" class="form-control" type="number" value="0"></td>
				 <td style="display:none;">0</td>
				 </tr>
				  <tr>
				 <td>1.00</td>
				 <td>x</td>
				 <td><input id="one" class="form-control" type="number" value="0"></td>
				<td style="display:none;">0</td>
				 </tr>
		...
		<div class="col-md-12">
				<div class="form-group" >
                     <p class="m-0 p-0" id="change_balance">Total Cash drawer:</p>
					 <div class="input-group input-group-sm m-1 p-1" >
						    
						  <input type="text" id="total_cash_drawer" name="total_cash_drawer" class="form-control float-right" style="height:40px;font-size:20px;font-weight:700;margin-right:3px;" value="0">
      ...
      <div class="modal-footer" style="padding:1px;">
        <button type="button" class="btn btn-primary" id="close_sale" style="margin:5px;width:100%;"  data-dismiss="modal">Close Sale</button>
      </div>
      </div>
  </div>
</div>
