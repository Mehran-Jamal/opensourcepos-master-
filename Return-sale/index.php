...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light p-1 m-0"  style="background-color:rgb(61, 61, 66);height:61px;">
  	   ...
  	   <button class="btn" id="showholdlist" disabled><span style="float:left;color:white;font-size:0.9rem;margin:0px;margin-top:30px;margin-right:10px;">HOLD</span></button>
  	   <button class="btn" id="returnitem"  disabled><span style="float:left;color:white;font-size:0.9rem;margin:0px;margin-top:30px;margin-right:10px;" disabled>RETURN</span></button> 
  	   <button class="btn" id="creditlist" disabled><span style="float:left;color:white;font-size:0.9rem;margin:0px;margin-top:30px;margin-right:10px;" disabled>CREDIT</span></button> 
  	   <button class="btn"  id="salelist" disabled><span style="float:left;color:white;font-size:0.9rem;margin:0px;margin-top:30px;margin-right:10px;" disabled>SALES</span></button> 
	  ...
	  <button class="btn" id="closeregister" disabled><span style="float:left;color:white;font-size:0.9rem;margin:0px;margin-top:30px;margin-right:10px;">CLOSE</span></button> 
