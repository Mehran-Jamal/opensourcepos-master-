				  ...
				  <td class="p-1"> 
				   <div class="input-group input-group-sm" style="width:120px;" >
						...
						<button type="submit" class="btn btn-warning p-1" style="color:#ffff;font-size:0.6rem;border-radius:3px 0px 0px 3px;" id="btn-sub">
						  ...
						  <input type="text" id="totalqty" name="totalqty" class="form-control float-right" value="<?php echo $qty;?>" style="padding:1px;height:30px;width:60px;text-align:center;">
  <div class="input-group-append">
				  ...
				  <?php
				  //DO NOT CLICK REMOVE IF ITEM IS ON HOLD
				  $gethold=mysqli_query($conn,"SELECT * FROM tblholditem WHERE cashierId='".$_SESSION['userid']."' AND productcode='".$row['productcode']."' AND onhold=1");
				  if(mysqli_num_rows($gethold)>0)
				  {

				  	echo ' <td class="p-1" style="text-align:center;">
				  <button class="btn btn-default btn-sm" id="cannotremove_hold">
				   <i class="fas fa-times m-0 p-0"  style="color:black;"></i>
				  </button>
				  </td>';
				  }else
				  {
