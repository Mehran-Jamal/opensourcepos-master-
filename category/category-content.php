...
//1.) SUBMIT TO DATABASE NEW SUPPLIR
 $("#categoryform").on('submit', function(e){
	  ...
	  $.ajax({
            type: 'POST',
            url: 'category-controller.php?save=1',
 ...
 $("#updateform").on('submit', function(e){
    ...
    $.ajax({
            type: 'POST',
            url: 'category-controller.php?update=1',
            data: new FormData(this), 
            dataType: 'json',
            contentType: false,
            cache: false,
  ...
  $(".table tbody").on('click', '#click-delete', function(e){
    ...
    var row=$(this).closest("tr"); //getting the selected row of table
	 ...
	 <div class="content-wrapper"  >
		...
		<h5 style="margin-left:2%; 	">Category Management </h5>
		...
		<ul class="navbar-nav ml-auto">
		  ...
		  <li class="nav-item dropdown">
			...
			<div class="dropdown-menu dropdown-menu-sm dropdown-menu-right" style="text-align:center;">
			  ...
			  <a href="#" class="dropdown-item" data-toggle="modal" data-target="#modal-lg"><span class="fas fa-plus-circle"></span> Add Category</a>
 ...
 <?php include('form-addcat.php');?>
			<?php include('deletecategory.php');?>
			 
 <?php include('form-updatecat.php');?>
