...
<?php include_once('../database.php');?>
  <?php
				 ...
				 <tr>
					...
					<td><input type="text" class="form-control"value="<?php echo $row['expirydate']?>" placeholder="Mm/Dd/Yyyy" ></td>
					<td><input type="text" id="batchnumber" class="form-control"value="<?php echo $row['batchnumber']?>" placeholder="Null"></td>
					...
					<td><input type="text" id="totalqty" class="form-control"value="<?php echo $row['totalqty'];?>"></td>  
