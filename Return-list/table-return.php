   <table   class="table table-bordered table-hover" id="tblactivity">
                 ...
                 <tr>
                    ...
                    <th style="border:none;">Cashier</th>
                    <th style="border:none;">Customer</th>
                    <th style="border:none;">Return reason</th>
                    <th style="border:none;">Return item</th>
                    <th style="border:none;">Total price</th> 
                    <th style="border:none;">Refund</th> 
                    <th style="border:none;">Previous Bal.</th> 
                    <th style="border:none;">Cash back</th> 
