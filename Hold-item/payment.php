	...
	$ftotal=0;
	$sql=mysqli_query($conn,"SELECT * FROM tblholditem WHERE holdname='".$_GET['hold']."'");
  ...
  <div class="modal-dialog" role="document" style="margin-left:22%;">
    <div class="modal-content" style="width:700px;">
      <div class="modal-header">
        <h6 class="modal-title" id="exampleModalLabel">Finalize payment(Hold item) </h6>
		...
		<div class="col-md-12">
					...
					<div class="form-group" >
					 ...
					 <div class="input-group input-group-md m-0 p-0" >
						  ...
						  <input type="search" id="amountpaid" name="amountpaid" class="form-control float-right" placeholder="0.00">
