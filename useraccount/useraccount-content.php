...
//1.) SUBMIT TO DATABASE NEW SUPPLIR
 $("#userform").on('submit', function(e){
	  ...
	  $.ajax({
            type: 'POST',
            url: 'useraccount-controller.php?save=1',
 ...
 $("#updateform").on('submit', function(e){
    ...
    $.ajax({
            type: 'POST',
            url: 'useraccount-controller.php?update=1',
            data: new FormData(this), 
            dataType: 'json',
            contentType: false,
            cache: false,
 ...
 //3.) DELETE FROM DATABASE
  ...
  $.ajax({
    type:'POST',
    url:'useraccount-controller.php',
    dataType:'html',
    async:false,
    cache:false,
    data:{
  ...
  $(".table tbody").on('dblclick', '#btn-status', function(e){
    ...
    var row=$(this).closest("tr"); //getting the selected row of table
      ...
      var status=row.find("td:eq(9) span").text();
...
return false;
 ...
 //click update button
  $(".table tbody").on('click', '#click-edit', function(e){
    ...
    var username = row.find("td:eq(7)").text(); 
    var password = row.find("td:eq(9)").text(); 
  ...
  $(".table tbody").on('click', '#click-delete', function(e){
    ...
    var row=$(this).closest("tr"); //getting the selected row of table
	 ...
	 <div class="content-wrapper"  >
		...
		<h5 style="margin-left:2%; 	">User Account Management </h5>
		...
		<ul class="navbar-nav ml-auto">
		  ...
		  <li class="nav-item dropdown">
			...
			<div class="dropdown-menu dropdown-menu-sm dropdown-menu-right" style="text-align:center;">
			  ...
			  <a href="#" class="dropdown-item" data-toggle="modal" data-target="#modal-lg"><span class="fas fa-plus-circle"></span> Add new User</a>
				  ...
				  <div class="card-body">
					 ...
					 <div class="card-tools float-left" style="margin-left:1.0rem;">
					  <div class="input-group input-group-sm" style="width:100%;padding-top:0.5rem;">
						  ...
						  <input type="text" name="table_search" class="form-control float-right" placeholder="Search product code, name here">
					 ...
					 <?php include('table-useraccount.php');?>
				  </div>
				  <!-- /.card-body -->
				</div>
				<!-- /.card -->
 ...
 <?php include('form-adduseraccount.php');?>
			<?php include('form-deleteuseraccount.php');?>
			 
 <?php include('form-updateuseraccount.php');?>
