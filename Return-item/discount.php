	<div class="modal modal-discount fade" id="tbl-payment" tabindex="-1" role="dialog" >
		...
		<div class="col-md-12">
					...
					<div class="form-group" >
					 ...
					 <div class="input-group input-group-md m-0 p-0" >
						  ...
						  <input type="text" id="add_discount" name="add_discount" class="form-control float-right" placeholder="0.00">
