...
$(document).ready(function(){ 
 ...
 $("#productform").on('submit', function(e){
	  ...
	  $.ajax({
            type: 'POST',
            url: 'expense-controller.php?save=1',
...
//update candidate to database
 $("#updateform").on('submit', function(e){
    ...
    $.ajax({
            type: 'POST',
            url: 'expense-controller.php?update=1',
            data: new FormData(this), 
            dataType: 'json',
            contentType: false,
            cache: false,
 ...
 //click delete button
  ...
  return false;
	 ...
	 <div class="content-wrapper"  >
		...
		<h5 style="margin-left:2%; 	">Expenses Management </h5>
		...
		<ul class="navbar-nav ml-auto">
		  ...
		  <li class="nav-item dropdown">
			...
			<div class="dropdown-menu dropdown-menu-sm dropdown-menu-right" style="text-align:center;">
			  ...
			  <a href="#" class="dropdown-item" data-toggle="modal" data-target="#modal-lg"><span class="fas fa-plus-circle"></span> Add Expense</a>
 ...
 <?php include('addnew-expense.php');?>
			<?php include('delete-expense.php');?>
			 
 <?php include('update-expense.php');?>
