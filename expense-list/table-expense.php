   <table   class="table table-bordered table-hover" id="tblactivity">
                 ...
                 <tr>
                    ...
                    <th style="border:none;">Detials</th>	
				  ...
				  <?php
				  $sql=mysqli_query($conn,"SELECT * FROM tblexpense ORDER BY expId DESC");
				  ...
				  ?>
				  <tr>
            <td style="display:none;" class="p-1"><?php echo $row['expId'];?></td>
				    <td class="p-1"><?php echo $qty;?></td> 
				    <td class="p-1"><?php echo $row['dateofexp'];?></td>
				    <td class="p-1"><?php echo $row['createdby'];?></td>
