...
.table tr {
    cursor: pointer;
	 ...
	 <div class="content-wrapper"  >
		...
		<h5 style="margin-left:2%; 	">Adjustment list </h5>
		...
		<ul class="navbar-nav ml-auto">
		  ...
		  <li class="nav-item dropdown">
			...
			<div class="dropdown-menu dropdown-menu-sm dropdown-menu-right" style="text-align:center;">
			  ...
			  <a href="../adjustment/index.php" class="dropdown-item"><span class="fas fa-plus-circle"></span> New Adjustment</a>
 ...
 <div class="card-tools float-left" style="margin-left:1.0rem;">
					 ...
					 <?php include('table-adjustment.php');?>
				  </div>
				  <!-- /.card-body -->
				</div>
				<!-- /.card -->
        ...
        <div class="modal-dialog modal-lg"  >
          <div class="modal-content">
            <div class="modal-header bg-secondary">
              <h4 class="modal-title">Item list (Adjustment)</h4>
			...
			<input type="hidden" id="purchaseid" value="">
				   ...
				   <table   class="table table-bordered table-hover p-0" id="tblactivity">
                 ...
                 <tr>
                    ...
                    <th class="p-1"   style="border:none;font-weight:400;">Supplier</th> 
                    <th  class="p-1" style="border:none;font-weight:400;">Mode</th>    
