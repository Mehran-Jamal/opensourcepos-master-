...
//1.) SUBMIT TO DATABASE NEW SUPPLIR
 $("#supplierform").on('submit', function(e){
	  ...
	  $.ajax({
            type: 'POST',
            url: 'supplierlist-controller.php?save=1',
 ...
 $("#updateform").on('submit', function(e){
    ...
    $.ajax({
            type: 'POST',
            url: 'supplierlist-controller.php?update=1',
            data: new FormData(this), 
            dataType: 'json',
            contentType: false,
            cache: false,
 ...
 //3.) DELETE FROM DATABASE
  ...
  $.ajax({
    type:'POST',
    url:'supplierlist-controller.php',
    dataType:'html',
    async:false,
    cache:false,
    data:{
...
return false;
  ...
  $(".table tbody").on('click', '#click-delete', function(e){
    ...
    var row=$(this).closest("tr"); //getting the selected row of table
	 ...
	 <div class="content-wrapper"  >
		...
		<h5 style="margin-left:2%; 	">Supplier Management </h5>
		...
		<ul class="navbar-nav ml-auto">
		  ...
		  <li class="nav-item dropdown">
			...
			<div class="dropdown-menu dropdown-menu-sm dropdown-menu-right" style="text-align:center;">
			  ...
			  <a href="#" class="dropdown-item" data-toggle="modal" data-target="#modal-lg"><span class="fas fa-plus-circle"></span> Add Supplier</a>
			  ...
			  <a href="#" class="dropdown-item " id="exportexcel">Export(CSV)</a>
				  ...
				  <div class="card-body">
					 ...
					 <?php include('table-supplier.php');?>
				  </div>
				  <!-- /.card-body -->
				</div>
				<!-- /.card -->
 ...
 <?php include('form-addsupplier.php');?>
			<?php include('deleteproduct.php');?>
			 
 <?php include('form-updatesupplier.php');?>
