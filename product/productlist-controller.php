...
$supplierid=0;
$supplier=0;
$insert = mysqli_query($conn,"INSERT INTO tblproduct (supId,supname,productcode,proname,secondname,category,prounit,cost,price,quantity,alertqty,expiredate,proimage,productstatus)
VALUES ('".$supplierid."','".$supplier."','".$code."','".$productname."','".$secondname."','".$category."','".$unit."','".$cost."','".$price."','".$qty."','".$alertqty."','0','".$image."','".$status."')");
...
$status = 'Updated';
 $sql="UPDATE tblproduct SET supId='".$supplierid."',supname='".$supplier."',productcode='".$code."',proname='".$productname."',secondname='".$secondname."',category='".$category."',prounit='".$unit."',cost='".$cost."',price='".$price."',alertqty='".$alertqty."',productstatus='".$status."' WHERE productId='".$productid."'";
